...
-(void)SetContentWith:(NSString *)text{
    ...
    CGFloat size = [text boundingRectWithSize:CGSizeMake(ScreenWidth - 80, HUGE) options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:dict context:nil].size.height;
